<div align="center">
  ...
  [![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-publicapihub.netlify.app-00C7B7?style=for-the-badge&logo=netlify&logoColor=white)](https://publicapihub.netlify.app)
  [![Download APK](https://img.shields.io/badge/📱_Download-Android_APK-3DDC84?style=for-the-badge&logo=android&logoColor=white)](https://github.com/ramkrishnajha5/API_Hub/releases/download/v1.0.0/API_Hub.apk)
...
├── components/
│   ├── ApiCard.tsx        # Individual API card component
│   ├── ApiDetailModal.tsx # API detail popup/page
│   ├── Layout.tsx         # Main layout with navbar & footer
│   └── ThemeToggle.tsx    # Animated dark/light mode toggle
├── pages/
│   ├── HomePage.tsx       # Main API explorer
│   ├── FavoritesPage.tsx  # Starred APIs collection
│   ├── AboutPage.tsx      # About the project
│   └── ContactPage.tsx    # Contact form & info
├── services/
│   └── apiService.ts      # API fetching logic
├── App.tsx                # Main app with routing
├── constants.tsx          # Icons and category mappings
...
[![Live Demo](https://img.shields.io/badge/🌐_Visit_Live_Site-publicapihub.netlify.app-00C7B7?style=for-the-badge&logo=netlify&logoColor=white)](https://publicapihub.netlify.app)
